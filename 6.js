...
async function crawlPage2() {
    ...
    // page1 la etofun
    // const data1 = [];
    // // const result = await axios.get('https://www.etopfun.com/api/schema/bcitemlist.do?appid=730&rows=100&page=1');
    // for (let i = 0; i <= 70; i++) {
    //     const result = await axios.get(`https://www.etopfun.com/api/schema/bcitemlist.do?appid=730&rows=100&page=${i}&quality=&rarity=&exterior=&lang=en`);
    ...
    while (true) {
        try {
            ...
            await page.waitForFunction(`${scrollElement}.scrollHeight > ${previousHeight}`, 69, { timeout: 60000 })
        } catch (e) {
